 ...
 * Description: ECGridOS Client to make calls to the ECGridOS API using the ECGridOS_Soap_Service Interface ServiceModel Interface
 * 
 * Take this starter template and build your own .Net Standard Library.
...
namespace ECGridOS_Standard_Library_Example
{
    /// <summary>
